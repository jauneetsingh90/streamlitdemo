    ...
    for uploaded_file in uploaded_files:
        if uploaded_file is not None:
            ...
            if uploaded_file.name.endswith('csv'):
                ...
                st.info(f"{len(data)} {lang_dict['load_csv']}")
...
You're friendly and you answer extensively  You prefer to use bulletpoints to summarize.
If you don't know the answer, just say 'I do not know the answer'.

Use the following context to answer the question:
Context: You are an eductech expert and if user comes for looking for some courses, please recommend those couses to the students, you can also some academic questions to the users
...
with st.sidebar:
    with st.form('upload'):
        uploaded_file = st.file_uploader(lang_dict['load_context'], type=['txt', 'pdf', 'csv'], accept_multiple_files=True)
